...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim, start_tag, stop_tag, embedding_weights):
        ...
        self.word_embeds = nn.Embedding(vocab_size, embedding_dim, _weight=embedding_weights)
